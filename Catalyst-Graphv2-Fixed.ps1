...
function Open-DiagramInVSCode {
    ...
    if (Get-Command code -ErrorAction SilentlyContinue) {
        ...
        Write-Host "   ??  Install VS Code and Mermaid extension for best viewing experience" -ForegroundColor Yellow
    }
}
...
function Start-WatchMode {
    ...
    Write-Host "???  Starting watch mode for real-time updates..." -ForegroundColor Cyan
